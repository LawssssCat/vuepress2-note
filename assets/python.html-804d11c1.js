import{_ as t,r as l,o as i,c as o,a as n,b as a,d as p,e}from"./app-01e1299e.js";const c={},r=e(`<p>相比其他语言，Python 丰富的的库几乎可以覆盖安全研究的方方面面，例如：</p><ul><li>Scapy 库可以很方便地实现跨平台的网络嗅探、网络发包等需求</li><li>PyPDF 文档分析工具提供强大的 PDF 格式解析功能，这些功能对 PDF 格式的 Fuzz 测试、PDF 0day 分析、PDF Exploit 的编写起到极大帮助</li><li>IDA 分析</li><li>代码审计</li><li>在 Exploit Safari 中，堆布局时非常关键的一环，lldb 提供的 Python 接口可以很方便地对 WebKit 对象进行分析，对每个 WebKit 对象大小以及快速发现对象的可利用特性2，对最终编写出完整的攻击代码了决定性的作用。</li></ul><p>todo IDAPython/IDC/Immunity Debugger/Valatility —— 纯Python打造的计算机内存取证分析工具</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>easy_install pyPDF python-nmap pygeoip mechanize BeautifulSoup4
